<x-guest-layout>
    <x-authentication-card>
        <x-slot name="logo">
            <img src="assets/img/logo/logo.png" alt="Logo" style="max-width:200px; height: auto;">
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button class="ms-4" style="background-color: #00D9A5; color: #ffffff; transition: background-color 0.3s;">
                    {{ __('Register') }}
                </x-button>
            </div>
        </form>
